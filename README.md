기술 스택 - React+TypeScipt+Tailwind+Next.js

**Next.js 기반의 커머스 또는 콘텐츠 플랫폼**
• **설명**: 검색 엔진 최적화(SEO)와 초기 로딩 속도가 중요한 **쇼핑몰**.
• **핵심 기술**: Next.js (App Router), SSR/SSG 활용, TanStack Query (React Query).
